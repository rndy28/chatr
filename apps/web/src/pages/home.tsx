...
const Home = () => {
  ...
  return (
    <Layout>
      ...
      <AnimatePresence>
        {conversationWith && <Main conversationWith={conversationWith} clearConversation={clearConversation} />}
      </AnimatePresence>
      <AnimatePresence>
        {!conversationWith && <State title="Chatr" description="Start chatting with your friends" key="state" />}
      </AnimatePresence>
    </Layout>
  );
};
